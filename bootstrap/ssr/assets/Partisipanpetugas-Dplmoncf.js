...
const _sfc_main = {
  __name: "Partisipanpetugas",
  __ssrInlineRender: true,
  props: {
    partisipans: {
      type: Object
      // Assuming partisipans is an object with a 'data' array
    },
    settings: {
      type: Object,
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Roles/EventAdmin/Partisipanpetugas.vue");
